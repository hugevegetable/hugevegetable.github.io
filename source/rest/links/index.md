...
- class_name: 友情链接
  ...
  link_list:
    ...
    - name: 萌傀儡`Blog
      ...
      descr: 珍惜现在，趁早摸鱼
      siteshot: https://jsd.onmicrosoft.cn/npm/blogassert/covers/1687615739569.png
    - name: 安知鱼
    ...
    - name: Tianlin
      ...
      avatar: https://gcore.jsdelivr.net/gh/linjiangyu2/halo@master/img/fa.jpg
      descr: 正因为是一张白纸 才可以随心所欲地描绘地图
      siteshot: https://gcore.jsdelivr.net/gh/linjiangyu2/halo@master/img/siteshot.jpg
    - name: Eurkon
